...
<body>
	...
	<div style="width: 70%; margin: auto;">
		<div id="container_box">
			...
			<form role="form" method="post" autocomplete="off"
				...
				<input type="hidden" name="gdsNum" value="${goods.gdsNum}" /> <label>1차분류</label>
				<select class="category1 form-select mb-3"
  ...
  <path
						...
						value="${goods.gdsName}" aria-label="Username"
				...
				<div class="input-group mb-4">
					<span class="input-group-text" id="basic-addon1">￦ </span> <input
						...
						value="${goods.gdsPrice}" aria-describedby="basic-addon1">
				</div>
				<div class="input-group mb-4">
					<span class="input-group-text" id="basic-addon1"><svg
							xmlns="http://www.w3.org/2000/svg" width="16" height="16"
  ...
  <path
						...
						value="${goods.gdsStock}" aria-describedby="basic-addon1">
				</div>
  ...
  <path fill-rule="evenodd"
					...
					<textarea class="form-control" aria-label="With textarea"
						id="gdsDes" name="gdsDes" rows="5" cols="50" style="resize: none;">${goods.gdsDes}</textarea>
				</div>
				<div class="mb-4">
					<label for="formFile" class="form-label"></label> <input
						class="form-control" type="file" id="gdsImg" name="file">
					<div class="select_img">
						<img src="${goods.gdsImg }" width=500px height=auto; /> <input
							type="hidden" name="gdsImg" value="${goods.gdsImg }" /> <input
							type="hidden" name="gdsThumbImg" value="${goods.gdsThumbImg }" />
					</div>
					<script>
						$("#gdsImg").change(
								function() {
